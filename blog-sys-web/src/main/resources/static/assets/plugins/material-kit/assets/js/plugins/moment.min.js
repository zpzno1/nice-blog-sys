...
! function(a, b) {
    ...
    // instance.  Otherwise, it will return the locale base
    ...
    var Le = w("moment().lang() is deprecated. Instead, use moment().localeData() to get the language base. Use moment().locale() to change languages.", function(a) {
