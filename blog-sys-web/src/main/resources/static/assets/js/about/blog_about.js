    ...
    plugin: {
        ...
        jqxtagcloud: {
            ...
            init: function (target) {
                ...
                blog_about.plugin.jqxtagcloud.settings.source = dataAdapter;
                target.jqxTagCloud(blog_about.plugin.jqxtagcloud.settings);
            }
        },
        /*注册步骤*/
        smartwizard: {
            ...
            init: function (target) {
                ...
                blog_about.plugin.smartwizard.settings.toolbarSettings.toolbarExtraButtons = [btnCancel, btnFinish];
                target.smartWizard(blog_about.plugin.smartwizard.settings);
            },
            event: {
